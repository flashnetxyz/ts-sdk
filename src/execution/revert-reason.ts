...
export const CONDUCTOR_REVERT_ERRORS: Readonly<Record<string, string>> = {
  ...
  "0x4184a38a": "BTCRefundFailed()",
  "0x3562a243": "Permit2TokenMismatch()",
  "0x9d2afe1d": "Permit2PairMismatch()",
  "0x5d7eb086": "WBTCNotInPosition()",
  "0x10074548": "ZeroLiquidity()",
  "0x70d645e3": "NotPositionOwner()",
  "0x9eab780e": "FeeRateTooHigh(uint16,uint16)",
  "0x2936ea68": "InvalidHostFeeSplit()",
  "0x9a1ce7a4": "NoFeeBalance()",
  "0x8199f5f3": "SlippageExceeded()",
  "0xbc3088ef": "DeadlineExpired(uint256)",
  "0xde1965d6": "ProtocolTreasuryNotSet()",
  "0x290645a2": "InvalidIntegrator()",
  "0xe9635f54": "NoHostRecipient()",
};
