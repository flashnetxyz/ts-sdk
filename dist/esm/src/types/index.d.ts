 ...
 */
export type NetworkType = "MAINNET" | "REGTEST" | "TESTNET" | "SIGNET" | "LOCAL";
/**
 * Maps legacy NetworkType to SparkNetworkType
 * @deprecated For migration purposes only
 */
export declare function getSparkNetworkFromLegacy(networkType: NetworkType): SparkNetworkType;
/**
 * Maps legacy NetworkType to ClientEnvironment
 * @deprecated For migration purposes only
 */
export declare function getClientEnvironmentFromLegacy(networkType: NetworkType): ClientEnvironment;
/**
 * Type guard to check if a value is a valid SparkNetworkType
 */
export declare function isSparkNetworkType(value: unknown): value is SparkNetworkType;
/**
 * Type guard to check if a value is a valid ClientEnvironment
 */
export declare function isClientEnvironment(value: unknown): value is ClientEnvironment;
...
export interface RouteSwapSimulationResponse extends SimulateRouteSwapResponse {
}
...
export type PoolSortOrder = "CREATED_AT_DESC" | "CREATED_AT_ASC" | "VOLUME24H_DESC" | "VOLUME24H_ASC" | "TVL_DESC" | "TVL_ASC";
...
export type SwapSortOrder = "timestampDesc" | "timestampAsc" | "amountInDesc" | "amountInAsc" | "amountOutDesc" | "amountOutAsc";
...
export type FeatureName = "master_kill_switch" | "allow_withdraw_fees" | "allow_pool_creation" | "allow_swaps" | "allow_add_liquidity" | "allow_route_swaps" | "allow_withdraw_liquidity";
...
export type ErrorCode = "InvalidRequest" | "MissingParameter" | "InvalidParameter" | "InvalidSignature" | "InvalidNonce" | "Unauthorized" | "TokenExpired" | "InvalidToken" | "NotFound" | "PoolNotFound" | "UserNotFound" | "InsufficientLiquidity" | "InsufficientBalance" | "SlippageExceeded" | "MinAmountNotMet" | "PoolInactive" | "InvalidRatio" | "RateLimitExceeded" | "InternalError" | "ServiceUnavailable" | "Timeout";
 ...
 */
export declare enum TimeComparison {
 ...
 */
export declare enum AmmStateCheckType {
    PHASE = 0,
    MINIMUM_RESERVE = 1,
    EXISTS = 2
}
 ...
 */
export type EscrowStatus = "PENDING_FUNDING" | "ACTIVE" | "COMPLETED" | "ABANDONED";
/**
 ...
 */
export declare function validateSingleSidedPoolThreshold(threshold: string, assetAInitialReserve: string): ValidationResult;
/**
 ...
 */
export declare function calculateThresholdPercentage(threshold: string, assetAInitialReserve: string): number;
/**
 ...
 */
export type DepositBalanceResponse = DepositBalanceSuccessResponse | DepositBalanceErrorResponse;
/**
